class SceneObject {
    ...
    pipeline(...args) {
        ...
        for (let face of this.faces) {
            ...
            // do pipeline for faces origins
            face.origin.pipeline(...args);
            face.origin.project();
    ...
    // calculate center point of every face
    updateFace(face) {
        // calculate center point
        face.origin = new Point(
            (face.points[0].initPos.at(0, 0) + face.points[1].initPos.at(0, 0) + face.points[2].initPos.at(0, 0)) / 3,
            (face.points[0].initPos.at(1, 0) + face.points[1].initPos.at(1, 0) + face.points[2].initPos.at(1, 0)) / 3,
            (face.points[0].initPos.at(2, 0) + face.points[1].initPos.at(2, 0) + face.points[2].initPos.at(2, 0)) / 3,
        )
    }
